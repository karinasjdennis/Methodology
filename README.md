...
This document describes how [GoCodeGreen (GCG)](https://gocode.green/) calculates the carbon emissions of the digital world, along with the protocol and specifications it is in compliance with.
