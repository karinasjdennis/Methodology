...
This document describes the fundamentals of corporate carbon accounting and outlines how [GoCodeGreen](https://gocode.green/) (GCG) implements the GHG Protocol's Guidance and [ISO Standard's Software Carbon Intensity (SCI) specification](https://www.iso.org/standard/86612.html#:~:text=This%20document%20describes%20a%20methodology,of%20an%20application's%20sustainability%20credentials.).
